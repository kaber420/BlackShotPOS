		...
		<div class="bg-base-100 p-6 rounded-3xl border border-base-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 group flex flex-col gap-5 min-h-[220px]">
			<div class="flex items-start gap-4">
				...
				<div class="flex flex-col min-w-0 flex-1">
					<h3 class="font-black text-xl tracking-tight leading-tight line-clamp-2" title={product.name}>{product.name}</h3>
					<span class="badge badge-ghost badge-xs font-black text-[9px] uppercase tracking-wider w-fit mt-1.5 border-none bg-base-200">
